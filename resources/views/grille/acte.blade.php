        ...
        function updatee() {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    showAlertTable('error', 'Erreur lors de la mise à jour de l\'acte.');
                }
            });
        }
...
<script>
    function generatePDF() {
        ...
        // Logo (ajoutez votre logo ici)
        // doc.addImage(logoImage, 'JPEG', 10, 10, 30, 30);

        // Informations de l'entreprise
        doc.setFontSize(16);
        doc.setFont("Helvetica", "bold");
        doc.text("ESPACE MEDICO SOCIAL LA PYRAMIDE DU COMPLEXE", 20, 10);
        doc.setFontSize(10);
        doc.setFont("Helvetica", "normal");
        doc.text("Abidjan Yopougon Selmer, Non loin du complexe sportif Jesse-Jackson - 04 BP 1523", 40, 25);
        doc.text("Tél.: 20 24 44 70 / 20 21 71 92 - Cel.: 01 01 01 63 43 / 01 01 01 63 43", 40, 30);

        //Ligne de séparation
        doc.setLineWidth(0.5);
        doc.line(10, 35, 200, 35); 

        // // Numéro de Reçu et Date/Heure
        // doc.setFontSize(12);
        // doc.setFont("Helvetica", "bold");
        // doc.text("RECU N° RCE24090103", 120, 45);
        ...
        // doc.text("Heure: " + new Date().toLocaleTimeString(), 120, 55);

        // // Informations du patient
        // doc.setFontSize(12);
        // doc.setFont("Helvetica", "bold");
        // doc.text("Nom patient(e):", 20, 65);
        // doc.setFont("Helvetica", "normal");
        // doc.text("DJEDOU DJEDOU JOSE GHISLAIN", 60, 65);

        // doc.setFont("Helvetica", "bold");
        // doc.text("Mode Règlement:", 20, 75);
        // doc.setFont("Helvetica", "normal");
        // doc.text("Espece", 60, 75);

        // doc.setFont("Helvetica", "bold");
        // doc.text("Service:", 120, 75);
        // doc.setFont("Helvetica", "normal");
        // doc.text("MEDECINE GENERALE", 150, 75);

        // // Informations du paiement
        // doc.setFont("Helvetica", "bold");
        // doc.text("MONTANT RECU:", 20, 90);
        // doc.setFont("Helvetica", "normal");
        // doc.text("1 000 XOF", 60, 90);

        // doc.setFont("Helvetica", "bold");
        // doc.text("Montant en lettres:", 20, 100);
        // doc.setFont("Helvetica", "normal");
        // doc.text("MILLE Francs CFA", 60, 100);

        // // Informations additionnelles
        // doc.setFont("Helvetica", "bold");
        // doc.text("CAISSIER(E):", 20, 120);
        // doc.setFont("Helvetica", "normal");
        // doc.text("DJEDOU", 60, 120);

        // doc.setFont("Helvetica", "bold");
        // doc.text("Contact Patient:", 120, 120);
        // doc.setFont("Helvetica", "normal");
        // doc.text("0777325295", 160, 120);

        // // Note au bas
        // doc.setFontSize(10);
        // doc.setFont("Helvetica", "normal");
        // doc.text("NB: RECU VALABLE POUR 15 JOURS UNIQUEMENT POUR UNE CONSULTATION DE LA MEME PATHOLOGIE.", 20, 135);

        // // Pied de page avec adresse
        // doc.setFont("Helvetica", "bold");
        // doc.setFontSize(10);
        // doc.text("ESPACE MEDICO SOCIAL LA PYRAMIDE DU COMPLEXE", 20, 150);
        // doc.text("Abidjan Yopougon Selmer, Non loin du complexe sportif Jesse-Jackson - 04 BP 1523 Abidjan 04", 20, 155);
        // doc.text("Tél.: 20 24 44 70 / 20 21 71 92 - Cel.: 01 01 01 63 43 / 01 01 01 63 43", 20, 160);

        // Générer et télécharger le fichier PDF
        // doc.save("recu_encaissement.pdf");
