...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function generatePDF(factures, price, id, date_fac, statut, date_paye) {
            ...
            jsPDFInvoiceTemplate.default(props).then(pdfCreated => {
                if (pdfCreated.blob) {
                    var blob = pdfCreated.blob; // Récupérer le Blob PDF
                    var blobUrl = URL.createObjectURL(blob); // Créer une URL pour le Blob
                    
                    // Afficher les informations du Blob
                    console.log("Blob URL: ", blobUrl);
                    alert("Blob URL: " + blobUrl);

                    // Ouvrir le PDF dans un nouvel onglet/fenêtre
                    window.open(blobUrl, '_blank');
                } else {
                    alert("Le Blob PDF n'a pas été créé.");
                }
            }).catch(error => {
            ...
            //  // Crée une URL pour ouvrir le PDF dans une nouvelle fenêtre
            // window.open(blobUrl, '_blank');
