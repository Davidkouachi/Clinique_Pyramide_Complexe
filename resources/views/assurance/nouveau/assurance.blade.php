    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-3">
                ...
                <form class="card-body" id="form_assurance" method="post" action="{{route('insert_assurance')}}" >
                    @csrf
                    <!-- Row starts -->
                    <div class="row gx-3">
                            ...
                            <table class="table align-middle table-hover m-0 truncate">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>
                                            <img height="40" width="40" class="rounded-circle" src="assets/images/assurance.jpg" alt="Bootstrap Gallery">
                                            {{$value->nom}}
                                        </td>
                                        <td>{{$value->email}}</td>
                                        <td>{{$value->fax}}</td>
...
<script src="{{asset('assets/js/app/js/nouveau/assurance.js')}}" ></script>
<script src="{{asset('assets/js/app/js/modifier/assurance.js')}}" ></script>
                ...
                <div class="row gx-3">
                    ...
                    <div class="col-12 text-center">
                        <div class="mb-3">
                            ...
                            <label class="form-label" for="nom">{{$value->localisation}}</label>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="Mmodif{{$value->id}}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="card-body" id="form_assurance_modifier" method="post" action="{{route('update_assurance',$value->id)}}" >
                    @csrf
                    <!-- Row starts -->
                    <div class="row gx-3">
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="tel2_modif" type="tel_modif" class="form-control" id="tel2_modif" placeholder="Autre contact (facultatif)" maxlength="10" value="{{$value->tel2}}">
                            </div>
                        </div>
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="mb-3">
                                <label class="form-label" for="fax_modif">Fax</label>
                                <input name="fax_modif" required type="text" class="form-control" id="fax_modif" placeholder="Fax de l'assurance" value="{{$value->fax}}">
                            </div>
                        </div>
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="mb-3">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="mb-3">
                                <label class="form-label" for="localisation_modif">Localisation</label>
                                <input required name="localisation_modif" type="text" class="form-control" id="localisation_modif" placeholder="Situation géographique de l'assurance" value="{{$value->localisation}}">
                            </div>
                        </div>
                        <div class="col-sm-12">
