...
<!-- Mirrored from storage.googleapis.com/theme-vessel-items/checking-sites/logdy-2-html/HTML/main/register-18.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 17:43:16 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="assets_login/img/favicon.ico" type="image/x-icon" >
                ...
                <div class="form-section">
                    <div class="logo-2">
                        <a href="login-18.html">
                            <img src="assets_login/img/logos/logo.png" alt="logo">
                        </a>
                    </div>
                    <div class="typing">
                    ...
                    <form action="#" method="GET">
                        <div class="form-group">
                            <label for="first_field" class="form-label float-start">Full Name</label>
                            <input name="name" type="text" class="form-control" id="first_field" placeholder="Full Name" aria-label="Full Name">
                        </div>
                        <div class="form-group">
                            <label for="second_field" class="form-label float-start">Email address</label>
                            <input name="email" type="email" class="form-control" id="second_field" placeholder="Email Address" aria-label="Email Address">
                        </div>
                        <div class="form-group clearfix">
                            <label for="third_field" class="form-label float-start">Password</label>
                            <input name="password" type="password" class="form-control" autocomplete="off" id="third_field" placeholder="Password" aria-label="Password">
                        </div>
